...
public class ModificarMecanicosControlador implements ActionListener{
	private ModificarMecanicosVista vistaControlador;
	private DAO_TallerMecanico daoControlador;
	
	
	public ModificarMecanicosControlador(ModificarMecanicosVista vistaControlador, DAO_TallerMecanico daoControlador) {
